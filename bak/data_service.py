...
token = "eEy9JV1qIajmoG4rO3TlYHwPNUzcIIs7ItntATi5OQjHEHsIIpmJUziwOsjJEb3MO7DOMBwBOCTwQUziOFTtl39"

ts.set_token(token)
pro = ts.pro_api()

pro._DataApi__token = token
pro._DataApi__http_url = 'https://fastapia.stockai888.top'
...
def get_sector_data(trade_date: str):
    ...
    merged = pd.merge(df_daily, stock_basic[["ts_code", "industry"]], on="ts_code", how="inner")
